...
[_EXTEND] = LAYOUT(
  QK_BOOT, KC_LGUI, KC_NO, KC_NO, KC_NO, KC_NO,            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, QK_BOOT,
  RGB_TOG, KC_ESC, CTL_A, CTL_F, CTL_E, KC_INS,            KC_CAPS, KC_DEL, KC_HOME, KC_END, KC_PGUP, BL_TOGG,
  RGB_MOD, OS_LALT, OS_LGUI, OS_LSFT, OS_LCTL, OS_RALT,    KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_PGDN, BL_STEP,
  KC_LSFT, CTL_Z, CTL_X, CTL_C, CTL_V, OS_CS, KC_NO,       KC_NO, KC_ENT, KC_BSPC, KC_TAB, KC_APP, KC_PSCR, BL_BRTG,
